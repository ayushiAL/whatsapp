            ...
            children: [
              ...
              ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    PersonChatModel model =
                        PersonChatList.personChatList[index];
                    return Row(
                      children: [
                        SizedBox(
                          width: 5,
                        ...
                        model.id == 2
                          ...
                          decoration: BoxDecoration(
                              ...
                              image:const DecorationImage(
                                  image:
                                  NetworkImage('https://blogger.googleusercontent.com/img/a/AVvXsEg4517n-Nh39lzAQuQaf10bhuUhKtKqoSrEXFTiv40T9J_7sN2byZm-UsuWBChCgSstZ3H8GV3t45tfIUx3dD1kE3QU8qMMAXDKUstH9qsVTwVv0xsyiNag6J2fSS_0e6mkaaocB3zsTisb9jZJTDREQiD93GkUSJht-cOLNZXrAL2XfLo7oHYjyHu_=w640-h400'),
                                  fit: BoxFit.cover)),
                              )
                            : Container()
                      ],
